...
A few decades later, Walter Cannon expanded the idea and coined the term *homeostasis*.

If you've survived medical school for more than twenty minutes you've probably encountered this word.

Homeostasis comes from the Greek words meaning roughly "similar standing."
...
Before we can talk about the state of a person, we need to identify the smallest meaningful unit of biological state.
...
The number tells you almost nothing about the countless cellular negotiations that produced it.

A temperature of 39°C is not the disease.

It is evidence of a state.

A heart rate of 140 beats per minute is not the disease.

It is evidence of a state.

Even symptoms themselves are often not diseases.

They are manifestations of state.

What we see clinically is usually the surface expression of deeper processes occurring across multiple levels of biological organization.
...
Because once you know where something is, the next question becomes obvious.

> Where is it going?

A patient isn't just sick.
